...
SCENE_CONFIGS = {
    "village": {
        ...
        "character_prompt": (
            ...
            "- Oversized cartoon head: the head takes up roughly ONE QUARTER to ONE THIRD of "
            "the character's total height — noticeably large but heroic, not grotesque\n"
            "- Body: approximately 4 heads tall when standing — compact and athletic, NOT fat, "
            "NOT wide. A slim-ish cartoon hero torso, narrow waist, slim legs\n"
            "- Chunky cartoon hands and forearms — but the torso and legs stay slim\n"
            "- Low camera angle: the viewer is positioned slightly below the character looking "
            "upward — this gives the large head a dynamic heroic feel\n\n"
            "IDENTITY (preserve exactly):\n"
            "- Skin tone, ethnicity, hair colour, hair texture, hairstyle, face shape\n"
            "- AGE: preserve the person's exact age — do NOT add wrinkles, age lines, "
            "sagging, or any signs of ageing. A young person must look young.\n"
            "- Natural proportionate cartoon ears — NOT protruding, NOT enlarged\n"
            "- Cartoon eyes that feel alive, while faithfully preserving this "
            "person's actual ethnicity, skin tone, and facial structure\n"
            "- {gender_hint}\n"
            "- This person is {subject}\n\n"
            "FACE STYLE (critical):\n"
            "- The face must be FULLY Pixar cartoon-stylized — smooth rounded cartoon skin, "
            "softened youthful features, warm subsurface glow\n"
            "- NOT photorealistic CGI. The face should look like it belongs in a Pixar film, "
            "not a realistic 3D render\n\n"
            "POSE (always use this, regardless of source image):\n"
            "- Full figure visible from feet to top of head\n"
            "- WHIMSICAL and FUN: a mid-motion joyful pose — body twisted with delight, "
            "one leg slightly raised or mid-stride, arms sweeping outward and upward, "
            "like they just burst into a spontaneous dance or are running with pure joy\n"
            "- The pose should feel like a freeze-frame of someone in the happiest moment "
            "of an adventure — dynamic, loose, full of energy\n"
            "- Face turned toward the viewer — face must be fully visible and unobscured\n"
            "- EXPRESSION (critical): broad genuine Duchenne smile — wide open eyes (NOT "
            "narrowed, NOT half-closed), eyebrows raised high in delight and surprise, cheeks "
            "pushed up, teeth showing in a wide warm grin. Warm and inviting, "
            "NOT intense, menacing, or sinister.\n\n"
            "STYLE:\n"
            ...
            "- Simple casual clothing, no logos — do NOT copy clothing from the source image\n"
            "- PURE WHITE BACKGROUND (#FFFFFF) — no gradients, no shadows, no environment, "
            "no ground plane. The character must be fully isolated on flat white.\n"
