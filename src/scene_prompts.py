...
SCENE_CONFIGS = {
    "village": {
        ...
        "character_prompt": (
            ...
            "- Slightly exaggerated Pixar cartoon proportions — expressive, warm eyes that "
            "feel alive, while faithfully preserving this person's actual ethnicity, skin tone, "
            "and facial structure. Do not go bug-eyed or alter jaw shape.\n"
            "- {gender_hint}\n"
            "- This person is {subject}\n\n"
            "POSE (always use this, regardless of source image):\n"
            "- Full standing figure, roughly waist-up visible\n"
            "- Dynamic adventurous pose: one arm outstretched, body mid-motion, energy and "
            "excitement in every limb — like a hero about to set off on a quest\n"
            ...
            "scattering, dramatic cartoon lighting\n"
