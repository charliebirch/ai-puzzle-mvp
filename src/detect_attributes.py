                ...
                "content": [
                    ...
                    },
                    {
                        ...
                        "text": (
                            ...
                            "   - If the face takes up less than about 20% of the image height (e.g. a full-body shot "
                            "taken from a distance), grade 'ok' and add a quality_issue like "
                            "'Full-body or distant shot — a closer photo with the face filling more of the frame "
                            "will produce a much better likeness'.\n\n"
